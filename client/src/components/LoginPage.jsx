  ...
  return (
    <div className="login-page">
      <div className="login-brand-bar">
        ...
        <div className="login-brand-text"><span className="login-brand-name">OUR</span><span className="login-brand-sub">Employee</span></div>
      </div>
      <div className="login-card-area">
        <div className="login-card">
          <div className="login-card-logo">
            ...
            <div className="login-card-brand"><span className="login-card-brand-name">OUR</span><span className="login-card-brand-sub">Employee</span></div>
          </div>
